        ...
        <CardHeader>
          ...
          <CardAction>
            <DropdownMenu>
              ...
              >
                <DotsVerticalIcon strokeWidth={2} />
              ...
              <DropdownMenuContent align="end" className="w-56">
                <DropdownMenuGroup>
                  ...
                  <DropdownMenuItem>
                    <FileIcon strokeWidth={2} />
                    New File
                    <DropdownMenuShortcut>⌘N</DropdownMenuShortcut>
                  </DropdownMenuItem>
                  <DropdownMenuItem>
                    <FolderIcon strokeWidth={2} />
                    New Folder
                    <DropdownMenuShortcut>⇧⌘N</DropdownMenuShortcut>
                  </DropdownMenuItem>
                  <DropdownMenuSub>
                    ...
                    <DropdownMenuPortal>
                      <DropdownMenuSubContent>
                        <DropdownMenuGroup>
                          ...
                          <DropdownMenuItem>
                            <KeyboardIcon strokeWidth={2} />
                            Keyboard Shortcuts
                          </DropdownMenuItem>
                          <DropdownMenuItem>
                            <LanguageIcon strokeWidth={2} />
                            Language
                          </DropdownMenuItem>
                          <DropdownMenuSub>
                            <DropdownMenuSubTrigger>
                ...
                <DropdownMenuGroup>
                  <DropdownMenuItem>
                    <CircleQuestionIcon strokeWidth={2} />
                    Help & Support
                  </DropdownMenuItem>
                  <DropdownMenuItem>
                    <FileIcon strokeWidth={2} />
