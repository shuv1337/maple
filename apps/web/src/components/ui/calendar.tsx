    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <ArrowLeftIcon strokeWidth={2} className={cn("size-4", className)} {...props} />
            )
          }

          if (orientation === "right") {
            return (
              <ArrowRightIcon strokeWidth={2} className={cn("size-4", className)} {...props} />
            )
          }

          return (
            <ArrowDownIcon strokeWidth={2} className={cn("size-4", className)} {...props} />
          )
        },
        DayButton: ({ ...props }) => (
